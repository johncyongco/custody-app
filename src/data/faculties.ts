...
export const faculties: FacultyInfo[] = [
  ...
  },
  {
    id: "eyes",
    label: "Eyes",
    description: "The eye is the lamp of the body. What you allow yourself to see shapes your soul.",
  ...
  },
  {
    id: "ears",
    label: "Ears",
    description: "Listening is the first language of love. Guard what you permit to enter through sound.",
  ...
  },
  {
    id: "hands",
    label: "Hands",
    description: "Work, service, creativity, and acts of love. What you build and offer.",
